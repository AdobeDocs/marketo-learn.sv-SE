...
+ Åtgärder för säljinsikter {#sales-insight-actions}
   + [Översikt](sales-insight-actions/overview.md)
   + [Översikt över åtgärder för säljinsikter](sales-insight-actions/sales-insight-actions-overview.md)
   + [Få tillgång till instansen med säljinsikter](sales-insight-actions/accessing-your-sales-insight-actions-instance.md)
